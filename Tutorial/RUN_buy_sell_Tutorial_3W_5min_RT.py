...
def main():
    ...
    # Create correlation matrix https://stackoverflow.com/questions/29294983/how-to-calculate-correlation-between-all-columns-and-remove-highly-correlated-on
        ...
        print("[4.1]uncorrelate_selection path: ", f'{tutorial_path}data/columns_select/{symbol}_{REF_MODEL}_columns.pkl')
        ...
        print("[5.1] Normalise_data path: ", f'{tutorial_path}data/scalers/{symbol}_{REF_MODEL}_scalex.pkl')
        ...
        print("[8.1] Class weight  path: ", f'{tutorial_path}data/class_weight/{symbol}_{REF_MODEL}_class_weight.pkl' , " Dict: " , dict_class_weight)
        ...
        print("[9.3] print diagram of the TF model Path: ", f'{tutorial_path}outputs/plots/{symbol}_{REF_MODEL}_buysell.png')
        ...
        print("[10.1] Model initial_weights saved : ",  f'{tutorial_path}data/initial_weights/{symbol}_{REF_MODEL}_initial_weights.tf')
        ...
        get_info_model_evaluation.get_info_model_evaluation(y_pred_1, y_test_a, symbol=symbol, indicator_timeframe= REF_MODEL, pwd=tutorial_path)
